        ...
        <nav className="sidebar-nav">
          {allNavigation
            .filter(item => {
              ...
              // Studio tier: leaderboards, tournaments, quests, communities, battle pass
              if (tier === 'studio') {
                return ['Leaderboards', 'Tournaments', 'Quests & Challenges', 'Communities', 'Battle Pass'].includes(item.name);
              }
